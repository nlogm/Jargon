...
public class EntityManager {
	...
	public static Body createBody(BodyDef b, Vector2 dimensions){
		try{
			bodyList.add(WorldManager.world.createBody(b));
	...
	public static void update(){
		...
		for(Body currentBody : bodyList){
			if(currentBody.getUserData() instanceof Sprite && currentBody.getUserData() != null){
				//For position
