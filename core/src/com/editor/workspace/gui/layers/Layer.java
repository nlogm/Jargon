package com.editor.workspace.gui.layers;
...
import com.editor.box2D.lights.Light;
...
public class Layer
{
    ...
    public static class Node extends Tree.Node
    {
        ...
        {
            super(new Label(name, EditorConstants.defaultSkin));
            //scene 2d skin

            //lbls
            Label imageLbl = new Label("Image", EditorConstants.defaultSkin);
            Label lightLbl = new Label("Light", EditorConstants.defaultSkin);
            Label bodyLbl = new Label("Body", EditorConstants.defaultSkin);

            //Initalze btns with text
            TextButton addImageBtn = new TextButton("+", EditorConstants.defaultSkin);
            TextButton addLightBtn = new TextButton("+", EditorConstants.defaultSkin);
            TextButton addBodyBtn = new TextButton("+", EditorConstants.defaultSkin);
            TextButton removeImageBtn = new TextButton("-", EditorConstants.defaultSkin);
            TextButton removeLightBtn = new TextButton("-", EditorConstants.defaultSkin);
            TextButton removeBodyBtn = new TextButton("-", EditorConstants.defaultSkin);
            /**
