...
public class BodyCreator {
	 ...
	 */
	public static HashMap<String, Object> createAndGetEntity(Vector2 position, Vector2 dimensions, BodyType type, boolean isCircle, String worldKey) {
	 ...
	 * @return the body created
	 */
	public static HashMap<String, Object> createAndGetEntity(Vector2 position, Vector2 dimensions, BodyType type, boolean isCircle, World world, int value) {
		HashMap<String, Object> bodyObjectsHash = new HashMap<String, Object>();
		...
		fixtureDef.restitution = 0;
		fixture = body.createFixture(fixtureDef);
		fixture.setUserData(((int) FixtureData.TOP_RIGHT_SENSOR | value));
		bodyObjectsHash.put(BodyReferences.FIX_TOP_RIGHT, fixture);
		rectangle.dispose();
		...
		fixtureDef.restitution = 0;
		fixture = body.createFixture(fixtureDef);
		fixture.setUserData(((int) FixtureData.TOP_LEFT_SENSOR | value));
		
		bodyObjectsHash.put(BodyReferences.FIX_TOP_LEFT, fixture);
		rectangle.dispose();
		...
		fixtureDef.restitution = 0;
		fixture = body.createFixture(fixtureDef);
		fixture.setUserData(((int) FixtureData.BOTTOM_LEFT_SENSOR | value));
		
		bodyObjectsHash.put(BodyReferences.FIX_BOTTOM_RIGHT, fixture);
		rectangle.dispose();
		...
		fixtureDef.restitution = 0;
		fixture = body.createFixture(fixtureDef);
		fixture.setUserData(((int) FixtureData.BOTTOM_RIGHT_SENSOR | value));
		
		bodyObjectsHash.put(BodyReferences.FIX_BOTTOM_LEFT, fixture);
		rectangle.dispose();
